...
import 'package:todolist/core/error/exceptions.dart';
...
class TaskRepositoryImpl implements TaskRepository {
  ...
  Future<Either<Failure, TodoModel>> createTask(
    ...
    if (await networkInfo.isConnected) {
      ...
      return const Left(ServerFailure(message: 'Server is Offline'));
    }
  }
  ...
  @override
  Future<Either<Failure, TodoModel>> viewTask(int id) async {
    if (await networkInfo.isConnected) {
      try {
