                ...
                return InkWell(
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      leading: Text(
                        '${taskManager.getTask(index).getID()}',
                      ...
                      title: Text(
                        taskManager.getTask(index).getTitle(),
                        style: const TextStyle(
                          fontFamily: 'Poppins',
                          fontWeight: FontWeight.bold,
                          fontStyle: FontStyle.normal,
                      ...
                      trailing: Row(
                        ...
                        children: [
                          Text(
                            taskManager.getTask(index).getDate(),
                            style: const TextStyle(
                              fontFamily: 'Poppins',
                          ...
                          Container(
                              ...
                              width: 3,
                              color: taskManager.getTask(index).getStatus() ==
                                      Status.completed
                                  ? Colors.green
                                  : taskManager.getTask(index).getStatus() ==
                                          Status.inProgress
                                      ? Colors.yellow
                                      : Colors.red)
                        ],
